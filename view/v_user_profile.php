  ...
  <div class="row">
    <div class="col-md-3 p-0 bg-dark collapse collapse-horizontal show">
      <ul class="list-group list-group-item-dark rounded-0 m-3">
        <li class="list-group-item list-group-item-action fw-bold">Tài Khoản Của Tôi</li>
        <li><a href="<?=$base_url?>page/history"class="list-group-item list-group-item-action fw-bold" >Lịch sử mua hàng</a></li>
        ...
        <div class="card-body">
          <form action="" method="post" onsubmit="return validatePassword();">
            <div class="row">
              ...
              <button type="submit" name="submit" class="btn btn-dark btn-block ">Cập Nhật</button>
